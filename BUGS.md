...
and how it was confirmed. When one is fixed, move the entry to `docs/bugs-fixed.md`
with the version that fixed it, rather than letting the archive grow here — this
file is read at the start of most sessions and the resolved half was most of it.
